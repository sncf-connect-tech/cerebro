...
@Component({
    ...
    templateUrl: './edit-alarm-3-compare.component.html'
})
export class EditAlarm3CompareComponent implements OnInit {
  ...
  getIllustrationSrc(): string {
    if (this.thresholdMode === 'static') {
      return 'assets/alarm/edit/edit-alarm-3-compare.images/observe-' + this.observeMode + '-compare-static.png';
    } else if (this.thresholdMode === 'history') {
        return 'assets/alarm/edit/edit-alarm-3-compare.images/observe-' + this.observeMode + '-compare-' + this.thresholdMode + '-'
          + this.analysisMode + '-' + (this.timeshiftNumber > 1 ? 'multi' : '1') + '.png';
    } else if (this.thresholdMode === 'holtwinters') {
        return 'assets/alarm/edit/edit-alarm-3-compare.images/observe-' + this.observeMode + '-compare-holtwinters.png';
    }
  }
